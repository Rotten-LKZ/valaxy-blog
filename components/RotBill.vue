...
import { ref } from 'vue'
import sponsers from '@/public/data/sponsers.json'
import expense from '@/public/data/expense.json'
import IconIncome from '@/public/icons/IconIncome.vue'
import IconSurplus from '@/public/icons/IconSurplus.vue'
import IconExpenditure from '@/public/icons/IconExpenditure.vue'
...
<template>
  <div class="rot-bill">
    <div class="rot-bill-summary">
      <span class="rot-bill-summary-income"><IconIncome />{{ t('bill.income') }}：{{ calcSponseSum() }}</span> 
      -
      <span class="rot-bill-summary-expenditure"><IconExpenditure />{{ t('bill.expenditure') }}：{{ calcExpenseSum() }}</span>
      =
      <span class="rot-bill-summary-surplus"><IconSurplus />{{ t('bill.surplus') }}：{{ calcSponseSum() - calcExpenseSum() }}</span>
    </div>
